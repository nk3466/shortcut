						...
						<div class="send_area">
							...
							<div class="row" style="height: auto;">
								...
								<div class="send_itme_detail">
									<input class="input_detail type1" id="selectpjt" type="text" name="addPjt" placeholder="Select Project" value="">
									<input class="input_detail type2" id="addPjt" type="button" name="addPjt" value="프로젝트"></div>
									<div id="project"></div>
								</div>
							...
							<div class="row" style="height: auto;">
								...
								<div class="send_itme_detail">
									...
									<input class="input_detail type2" id="addMember" type="button" name="addMember" value="멤버추가"></div>
									<div id="member"></div>
							</div>

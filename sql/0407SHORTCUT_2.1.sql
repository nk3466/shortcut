...
INSERT INTO CRD_TASK
( TK_PROGRESS, CRD_NO, MEM_NO, TK_START_DATE, TK_END_DATE)VALUES
( 2, 22, 1, TO_DATE(TO_CHAR(ADD_MONTHS(SYSDATE, 0), 'YYYY-MM-DD')) - 10, TO_DATE(TO_CHAR(ADD_MONTHS(SYSDATE, 0), 'YYYY-MM-DD')) - 1);
COMMIT;
--
INSERT INTO BACKLOG
( BLG_NO, BLG_NAME, BLG_PRI, BLG_ENROLL_DATE, PJT_NO, BLG_DEL_YN, BLG_DEMO_MEMO, BLG_REF_MEMO )VALUES
...
INSERT INTO CRD_TASK
( TK_PROGRESS, CRD_NO, MEM_NO, TK_START_DATE, TK_END_DATE)VALUES
( 2, 23, 1, TO_DATE(TO_CHAR(ADD_MONTHS(SYSDATE, 0), 'YYYY-MM-DD')) - 10, TO_DATE(TO_CHAR(ADD_MONTHS(SYSDATE, 0), 'YYYY-MM-DD')) - 1);
COMMIT;
--
INSERT INTO BACKLOG
( BLG_NO, BLG_NAME, BLG_PRI, BLG_ENROLL_DATE, PJT_NO, BLG_DEL_YN, BLG_DEMO_MEMO, BLG_REF_MEMO )VALUES
...
INSERT INTO CRD_TASK
( TK_PROGRESS, CRD_NO, MEM_NO, TK_START_DATE, TK_END_DATE)VALUES
( 2, 24, 1, TO_DATE(TO_CHAR(ADD_MONTHS(SYSDATE, 0), 'YYYY-MM-DD')) - 10, TO_DATE(TO_CHAR(ADD_MONTHS(SYSDATE, 0), 'YYYY-MM-DD')) - 1);
COMMIT;
--
INSERT INTO BACKLOG
( BLG_NO, BLG_NAME, BLG_PRI, BLG_ENROLL_DATE, PJT_NO, BLG_DEL_YN, BLG_DEMO_MEMO, BLG_REF_MEMO )VALUES
...
INSERT INTO CRD_TASK
( TK_PROGRESS, CRD_NO, MEM_NO, TK_START_DATE, TK_END_DATE)VALUES
( 2, 25, 1, TO_DATE(TO_CHAR(ADD_MONTHS(SYSDATE, 0), 'YYYY-MM-DD')) - 10, TO_DATE(TO_CHAR(ADD_MONTHS(SYSDATE, 0), 'YYYY-MM-DD')) - 1);
COMMIT;
--
INSERT INTO BACKLOG
( BLG_NO, BLG_NAME, BLG_PRI, BLG_ENROLL_DATE, PJT_NO, BLG_DEL_YN, BLG_DEMO_MEMO, BLG_REF_MEMO )VALUES
...
INSERT INTO CRD_TASK
( TK_PROGRESS, CRD_NO, MEM_NO, TK_START_DATE, TK_END_DATE)VALUES
( 2, 26, 1, TO_DATE(TO_CHAR(ADD_MONTHS(SYSDATE, 0), 'YYYY-MM-DD')) - 10, TO_DATE(TO_CHAR(ADD_MONTHS(SYSDATE, 0), 'YYYY-MM-DD')) - 1);
COMMIT;
--
INSERT INTO BACKLOG
( BLG_NO, BLG_NAME, BLG_PRI, BLG_ENROLL_DATE, PJT_NO, BLG_DEL_YN, BLG_DEMO_MEMO, BLG_REF_MEMO )VALUES
...
INSERT INTO CRD_TASK
( TK_PROGRESS, CRD_NO, MEM_NO, TK_START_DATE, TK_END_DATE)VALUES
( 2, 27, 1, TO_DATE(TO_CHAR(ADD_MONTHS(SYSDATE, 0), 'YYYY-MM-DD')) - 10, TO_DATE(TO_CHAR(ADD_MONTHS(SYSDATE, 0), 'YYYY-MM-DD')) - 1);
COMMIT;
